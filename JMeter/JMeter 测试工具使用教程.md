...
![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464157/image-preview)

![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464159/image-preview)
...
![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464160/image-preview)
### 二、 运行JMeter
1. 从解压出来的文件夹中找到bin文件夹然后在bin文件夹里面找到 jmeter.bat，双击jmeter.bat等待JMeter启动。
![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464161/image-preview)
![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464162/image-preview)
2. 添加线程组
![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464163/image-preview)
3. 设置线程组参数
...
4. 添加被测页面
- 添加被测API。
![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464171/image-preview)
- 设置请求参数。
![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464178/image-preview)
- 为了方便测试可以将服务域名保存在用户定义的变量中（*Add —> Config Element —> User Defined Variables*）。
![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464189/image-preview)
- 为了模拟多账户可以在被测页面中添加用户参数(*Add —> Pre Processors —> User Parameters*)。
![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464190/image-preview)
- 为了正确请求被测页面可能需要带上请求头信息，可以使用HTTP信息头管理器(*Add —> Config Element —> HTTP Header Manager*)。
![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464191/image-preview)
- 如果保存登录信息时使用到了Cookie，可以使用HTTP Cookie管理器(*Add —> Config Element —> HTTP Cookie Manager*)。
![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464192/image-preview)
- 为了方便查看结果可以被测页面添加查看结果树(*Add —> Listener —> View Results Tree*)。
![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464193/image-preview)
5. 保存设置并运行
![image.png](https://api.apifox.com/api/v1/projects/2629312/resources/464194/image-preview)
6. Demo 
